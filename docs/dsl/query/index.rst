...
ForML :ref:`projects <project>` from their original data sources represented by their logical
:ref:`schemas <schema>`.
...
target storage layer hosting the physical data sources :ref:`matching <io-resolution>` the requested
schemas.
