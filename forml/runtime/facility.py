...
class Virtual:
    ...
    class Builder:
        ...
        apply = property(lambda self: Virtual.Builder.Handler(self, Platform.Launcher.apply))
        eval = property(lambda self: Virtual.Builder.Handler(self, Platform.Launcher.train_eval))
        tune = property(lambda self: Virtual.Builder.Handler(self, Platform.Launcher.tune))
        ...
        def __call__(self, sink: io.Sink) -> 'Platform.Launcher':
            return Platform(self._runner, self._registry, self._feeds, sink).launcher(self._project)
