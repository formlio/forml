...
class Adapter(topology.Operator, metaclass=abc.ABCMeta):
    ...
    class Builder:
        ...
        class Setter:
            ...
            def spec(self, *args, **kwargs) -> typing.Optional[task.Spec]:
    ...
    def __init__(
        ...
        self._apply: typing.Optional[task.Spec] = apply
        self._train: typing.Optional[task.Spec] = train
