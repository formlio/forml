...
This is one of the main _formal_ forml components (along with `pipeline`) that's being looked up by the forml
loader. In this case it is implemented as a python package but it could be as well just a module `source.py`.
