...
class TestScenario:
    ...
    def test_plainapply_raises(
        self,
        plainapply_raises: spec.Scenario,
    ...
    def test_plainapply_returns(
        self,
        plainapply_returns: spec.Scenario,
        hyperparams: typing.Mapping[str, int],
        apply_input: str,
        apply_output: str,
    ):
    ...
    def test_statetrain_raises(
        self,
        statetrain_raises: spec.Scenario,
        hyperparams: typing.Mapping[str, int],
        train_input: str,
        label_input: str,
        exception: Exception,
    ...
    def test_statetrain_returns(
        self,
        statetrain_returns: spec.Scenario,
        hyperparams: typing.Mapping[str, int],
        train_input: str,
        label_input: str,
        train_output: str,
    ...
    def test_stateapply_raises(
        self,
        stateapply_raises: spec.Scenario,
        hyperparams: typing.Mapping[str, int],
        train_input: str,
        label_input: str,
        apply_input: str,
    ...
    def test_stateapply_returns(
        self,
        stateapply_returns: spec.Scenario,
        hyperparams: typing.Mapping[str, int],
        train_input: str,
        label_input: str,
        apply_input: str,
